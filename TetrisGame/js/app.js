document.addEventListener('DOMContentLoaded', () => {
  ...
  const resbtn = document.querySelector('.button1')
  ...
  resbtn.addEventListener('click', () => {
    ...
    if (confirm("you wanna really restart your game, All you efforts till now will go into vain!   " + emoji)) {
      location.reload()
    } else {
      var emo = String.fromCodePoint(0x263A)
      txt = "Good you chose to continue the Game!, Please go on beat you personal High Score, All the Best   " + emo;
      alert(txt)
    }
  })
